...
OWNER_USERNAME = getenv("OWNER_USERNAME","Lucifer_xd_069")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "AVAXMUSIC_BOT")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "AVA X MUSIC")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "Ava_music_143")
...
OWNER_ID = int(getenv("OWNER_ID", 6432708510))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/madmaxopsashikant/avamusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/THEINCREDIBLESTORYS")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/THEINCREDIBLE0")
